...
export default function CTABanner({
  ...
  subtitle = "Join 500+ happy Sydney customers. Get your free quote in under 60 seconds.",
}) {
  return (
    <section className="bg-brand-600 py-16 px-6">
      <div className="max-w-4xl mx-auto text-center" data-reveal>
        ...
        <p className="text-brand-100 text-lg mb-8">{subtitle}</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/get-quote"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-brand-600 font-bold text-base rounded-xl hover:bg-brand-50 transition-colors shadow-lg"
          >
