const transformations = [
  {
    room: 'Kitchen',
    beforeImage: '/images/before-kitchen.png',
    afterImage: '/images/after-kitchen.png',
    beforeDesc: 'Greasy stovetop, stained benchtops, dirty splashback',
    afterDesc: 'Gleaming surfaces, spotless oven, streak-free splashback',
  },
  {
    room: 'Bathroom',
    beforeImage: '/images/before-bathroom.png',
    afterImage: '/images/after-bathroom.png',
    beforeDesc: 'Mould, soap scum, hard water stains on glass and tiles',
    afterDesc: 'Sanitised tiles, crystal-clear glass, fresh and odour-free',
  },
  {
    room: 'Living Room',
    beforeImage: '/images/before-living-room.png',
    afterImage: '/images/after-living-room.png',
    beforeDesc: 'Dusty carpets, messy surfaces, clutter in the room',
    afterDesc: 'Vacuumed carpets, polished surfaces, fresh-scented air',
  },
]
