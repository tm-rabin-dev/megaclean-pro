...
export default function AnnouncementBar({ onDismiss }) {
  return (
    <div className="bg-brand-800 text-white py-2.5 px-4 flex items-center justify-center relative">
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-sm font-medium pr-8">
        ...
        <span className="text-white/30 hidden sm:inline">·</span>
        <span className="text-white/70 hidden sm:inline">Serving all Sydney suburbs</span>
      </div>
      <button
        onClick={onDismiss}
